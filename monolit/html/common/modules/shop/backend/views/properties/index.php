...
$this->title = Yii::t('backend/products', 'Products') . (isset($category) ? ' (' . $category->header . ')' : '');
$this->params['breadcrumbs'][] = $this->title;
?>

    <div class="pull-right">
        <?= Html::a('<i class="ion-plus-round"></i> ' . Yii::t('backend/pages', 'Добавить характеристику'), ['create'], ['class' => 'btn btn-sm btn-primary']) ?>
    </div>
