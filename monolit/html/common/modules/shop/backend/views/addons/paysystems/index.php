...
$this->title = Yii::t('backend/products', 'Paysystems') . (isset($parent) ? ' (' . $parent->title . ')' : '');
$this->params['breadcrumbs'][] = $this->title;
?>

    <div class="pull-right">
        <?= Html::a('<i class="ion-plus-round"></i> ' . Yii::t('backend/pages', 'Добавить способ оплаты'), ['create'], ['class' => 'btn btn-sm btn-primary']) ?>
    </div>
