                        ...
                        <div class="tab-content">
                            ...
                            foreach ($languages as $language): ?>
                                ...
                                <div class="tab-pane <?= $language->code == $lang ? 'active' : '' ?>" role="tabpanel"
                                    ...
                                    <?= $form->field($model->translate($language->code), '[' . $language->code . ']content2')->widget(TinyMCE::className(), [
                                        'clientOptions' => [
                                            'language' => 'ru',
                                            'menubar' => true,
                                            'height' => 500,
                                    ...
                                    <?= $form->field($model->translate($language->code), '[' . $language->code . ']html')->textarea(['rows' => 6]) ?>

                                    <?= $form->field($model->translate($language->code), '[' . $language->code . ']html2')->textarea(['rows' => 6]) ?>
        ...
        <div class="row">
            <div class="col-md-12">
                 <?= $form->field($model,'type')->dropdownList(
                    ArrayHelper::map(UnitTypes::find()->all(), 'id', 'name')
                ) ?>
            </div>
            <div class="col-md-12">
