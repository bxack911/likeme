...
?>
    ...
    <div class="pull-right">
        <?= Html::a('<i class="ion-plus-round"></i> ' . Yii::t('backend/pages', 'Добавить перевод'), ['create'], ['class' => 'btn btn-sm btn-primary']) ?>
    </div>
                    ...
                    <div class="table-responsive">
                        <?= GridView::widget([
                            ...
                            'columns' => [
                                ...
                                [
                                    'attribute' => 'str_key',
                                    'label' => Yii::t('backend/pages', 'Key'),
                                    'value' => function ($model) {
                                        return $model->str_key;
                                    }

                                ],
                                [
                                  'attribute' => 'value',
                                  'label' => Yii::t('backend/pages', 'Value'),
                                  'value' => function ($model) {
                                    return $model->translate(Yii::$app->config->get('pagesLanguage'))->value;
                                  }
